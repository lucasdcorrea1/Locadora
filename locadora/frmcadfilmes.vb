...
Public Class frmcadfilmes
    ...
    Private Sub alterar_registro()
        ...
        SQL = "Update FILMES set GENERO=@GENERO,DURACAO=@DURACAO,ANO=@ANO,TITULO=@TITULO"
        ...
        CM.Parameters.Add("@TITULO", SqlDbType.VarChar).Value = txttitulo.Text
    ...
    Private Sub incluir_registro()
        If (txtfilme.Text = "" Or txtduracao.Text = "" Or txtlancamento.Text = "" Or txttitulo.Text = "") Then
            MsgBox("Preencha todos os campos vazios")
        Else
            Dim CM As SqlCommand
            Dim SQL As String
            SQL = "Insert into FILMES (GENERO,DURACAO,ANO,TITULO) values ("
            SQL = SQL + "@GENERO,@DURACAO,@ANO,@TITULO)"
            CM = New SqlCommand(SQL, CONN)
            CM.Parameters.Add("@GENERO", SqlDbType.VarChar).Value = txtfilme.Text
            CM.Parameters.Add("@DURACAO", SqlDbType.VarChar).Value = txtduracao.Text
            CM.Parameters.Add("@ANO", SqlDbType.VarChar).Value = txtlancamento.Text
